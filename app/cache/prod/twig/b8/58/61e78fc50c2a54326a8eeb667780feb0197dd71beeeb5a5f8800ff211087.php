    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "<article class=\"col-xs-12 col-sm-12 article\">
            ...
            <div class=\"date\">
                ...
                ";
        // line 9
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["single"]) ? $context["single"] : null), "createAt", array()), "Y-m-d H:i:s"), "html", null, true);
        echo "
            </div>
            <h1 class=\"title\">";
        // line 11
        ...
        echo "</h1>
            <p>
                ";
        // line 13
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["single"]) ? $context["single"] : null), "content", array()), "html", null, true);
        echo "
            </p>
