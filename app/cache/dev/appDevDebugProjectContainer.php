...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Library/WebServer/Documents/sii/project-sii/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Library/WebServer/Documents/sii/project-sii/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Library/WebServer/Documents/sii/project-sii/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test_project', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_44533786d28f64714ff56ce820c075b4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_44533786d28f64714ff56ce820c075b4');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_44533786d28f64714ff56ce820c075b4');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Library/WebServer/Documents/sii/project-sii/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity', 1 => '/Library/WebServer/Documents/sii/project-sii/src/My/UserBundle/Entity', 2 => '/Library/WebServer/Documents/sii/project-sii/src/My/BackendBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Gedmo\\Translatable\\Entity');
        $f->addDriver($e, 'My\\UserBundle\\Entity');
        $f->addDriver($e, 'My\\BackendBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/Library/WebServer/Documents/sii/project-sii/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Translatable\\Entity', 'MyUserBundle' => 'My\\UserBundle\\Entity', 'MyBackendBundle' => 'My\\BackendBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/Library/WebServer/Documents/sii/project-sii/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Library/WebServer/Documents/sii/project-sii/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('My\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('My\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('My\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('My\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'My\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Library/WebServer/Documents/sii/project-sii/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Library/WebServer/Documents/sii/project-sii/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Library/WebServer/Documents/sii/project-sii/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Library/WebServer/Documents/sii/project-sii/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Library/WebServer/Documents/sii/project-sii/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Library/WebServer/Documents/sii/project-sii/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Library/WebServer/Documents/sii/project-sii/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Library/WebServer/Documents/sii/project-sii/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/app/Resources/FOSUserBundle/views', 'FOSUser');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/friendsofsymfony/user-bundle/Resources/views', 'FOSUser');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/src/My/UserBundle/Resources/views', 'MyUser');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/src/My/BackendBundle/Resources/views', 'MyBackend');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/src/My/FrontendBundle/Resources/views', 'MyFrontend');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/app/Resources/views');
        $instance->addPath('/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Library/WebServer/Documents/sii/project-sii/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Library/WebServer/Documents/sii/project-sii/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Library/WebServer/Documents/sii/project-sii/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/Library/WebServer/Documents/sii/project-sii/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml', 2 => '/Library/WebServer/Documents/sii/project-sii/vendor/friendsofsymfony/user-bundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Library/WebServer/Documents/sii/project-sii/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev',
            'kernel.logs_dir' => '/Library/WebServer/Documents/sii/project-sii/app/logs',
            'kernel.bundles' => array(
                ...
                'MyUserBundle' => 'My\\UserBundle\\MyUserBundle',
                'MyBackendBundle' => 'My\\BackendBundle\\MyBackendBundle',
                'DoctrineMigrationsBundle' => 'Doctrine\\Bundle\\MigrationsBundle\\DoctrineMigrationsBundle',
                'MyFrontendBundle' => 'My\\FrontendBundle\\MyFrontendBundle',
            ...
            'debug.container.dump' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Library/WebServer/Documents/sii/project-sii/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/Library/WebServer/Documents/sii/project-sii/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml',
                2 => '/Library/WebServer/Documents/sii/project-sii/vendor/friendsofsymfony/user-bundle/Resources/config/validation/orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Library/WebServer/Documents/sii/project-sii/app/cache/dev/profiler',
            ...
            'router.resource' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Library/WebServer/Documents/sii/project-sii/app/../web',
            'assetic.write_to' => '/Library/WebServer/Documents/sii/project-sii/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Library/WebServer/Documents/sii/project-sii/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'My\\UserBundle\\Entity\\User',
            ...
            'doctrine_migrations.dir_name' => '/Library/WebServer/Documents/sii/project-sii/app/DoctrineMigrations',
