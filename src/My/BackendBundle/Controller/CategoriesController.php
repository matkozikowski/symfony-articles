...
use My\BackendBundle\Entity\Categories;
use My\BackendBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyBackendBundle:Categories')->findAll();
     ...
     * @Method("POST")
     * @Template("MyBackendBundle:Categories:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyBackendBundle:Categories')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MyBackendBundle:Categories:edit.html.twig")
     */
